...
//     if(files.length>5)return next(new ErrorHandler("Files cant be more 5",400))
...
// //     const messagesWithAttachments = await Message.findById({ chat: chatId, attachments: { $exists: true, $ne: [] } });
